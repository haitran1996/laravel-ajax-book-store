...
@section('content')
    <section class="slider">
        <div class="container">
            <div id="owl-demo" class="owl-carousel owl-theme">
                ...
                <div class="item">
                    <div class="slide">
                        <img src="{{asset('images/slide2.jpg')}}" alt="slide1">
                        <div class="content">
                            <div class="title">
                                <h3>welcome to bookstore</h3>
                                <h5>Discover the best books online with us</h5>
                ...
                <div class="item">
                    <div class="slide">
                        <img src="{{asset('images/slide3.jpg')}}" alt="slide1">
                        <div class="content">
                            <div class="title">
                                <h3>welcome to bookstore</h3>
                                <h5>Discover the best books online with us</h5>
                ...
                <div class="item">
                    <div class="slide">
                        <img src="{{asset('images/slide4.jpg')}}" alt="slide1">
                        <div class="content">
                            <div class="title">
                                <h3>welcome to bookstore</h3>
                                <h5>Discover the best books online with us</h5>
    ...
    <section class="about-sec">
        <div class="about-img">
            <figure style="background:url({{asset('images/about-img.jpg')}})no-repeat;"></figure>
        </div>
